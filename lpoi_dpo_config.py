...
class DPOConfig(TrainingArguments):
    ...
    Args:
        ...
        add_image_dpo ('bool', *optional*, defaults to `False`):
            Whether to add image DPO loss to the total loss.
        add_list_text_dpo ('bool', *optional*, defaults to `False`):
            Whether to add listwise text DPO loss to the total loss.
    """
    ...
    add_list_text_dpo: bool = False
    vlm_loss_type: Tuple[str] = ("a", "i", "t")
